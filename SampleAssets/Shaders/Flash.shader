...
#define _EmissionColor_arr UdonShipSimulatorFlash
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float mulTime4 = _Time.y * ( 1.0 / _Duration );
			o.Emission = ( _EmissionColor_Instance * step( frac( mulTime4 ) , _Dt ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18900
0;1203;1750;877;2004.389;462.8768;1.720069;True;True
Node;AmplifyShaderEditor.RangedFloatNode;9;-900.5,516;Inherit;False;Property;_Duration;Duration;3;0;Create;True;0;0;0;False;0;False;2;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-763.5,641;Inherit;False;Property;_Dt;Dt;2;0;Create;True;0;0;0;False;0;False;0.9;0.9;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6BBBA48A23ECB87BCDB911E05191A7143A0A0D13