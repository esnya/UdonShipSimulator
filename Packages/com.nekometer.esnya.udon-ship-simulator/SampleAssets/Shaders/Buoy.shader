...
#define _Color_arr UdonShipSimulatorBuoy
			UNITY_DEFINE_INSTANCED_PROP(float4, _EmissionColor)
#define _EmissionColor_arr UdonShipSimulatorBuoy
...
#define _Shape_arr UdonShipSimulatorBuoy
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( _Color_Instance * max( ( 1.0 - i.vertexColor.r ) , 0.1 ) ).rgb;
			...
			o.Emission = ( _EmissionColor_Instance * i.vertexColor.r * step( frac( ( mulTime51 + simpleNoise60 ) ) , _Dt ) ).rgb;
...
/*ASEBEGIN
Version=18900
0;1211;1750;869;1894.487;1235.894;2.235513;True;True
...
Node;AmplifyShaderEditor.ColorNode;1;-96.7371,-729.9128;Inherit;False;InstancedProperty;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0.8,0.8,0.8,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;48;-80,-208;Inherit;False;InstancedProperty;_EmissionColor;EmissionColor;1;1;[HDR];Create;True;0;0;0;False;0;False;771.0118,771.0118,771.0118,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=82CBAB4176A7CC3D6F94AC8DA05730B700A3D9FE