...
namespace USS2
{
    ...
    public class AnalogValueController : UdonSharpBehaviour
    {
        /// <summary>
        /// Target udon behaviour.
        /// </summary>
        [CanBeNull] public UdonSharpBehaviour target;
        ...
        [PublicAPI] public void SetHalf()
        {
            _TakeOwnership();
            Value = 0.5f;
        }

        [PublicAPI] public void Set1()
        {
            _TakeOwnership();
            Value = 1.0f;
        }
