...
namespace USS2
{
    ...
    public class RoundGauge : UdonSharpBehaviour
    {
        /// <summary>
        ...
        private void Start()
        {
            indicatorRotation = indicator.localRotation;
        }
        ...
        private  void OnWillRenderObject()
        {
            ...
            indicator.localRotation = indicatorRotation * Quaternion.AngleAxis(absValue * maxAngle / maxValue, axis);
